...
def call() {
    ...
    sh("mvn -Djacoco.skip=true -DskipSourceCompile=true -DskipTestCompile=true -Dskip.surefire.tests=true -Dskip.failsafe.tests=true -Dartifact.repo.host=${NEXUS_HOSTNAME} -Dartifact.repo.port=${NEXUS_SERVICE_PORT} -s dynamic-settings.xml -e deploy")
/*
